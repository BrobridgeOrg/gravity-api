...
type Entity struct {
	...
	EntityInfo []byte `protobuf:"bytes,4,opt,name=entityInfo,proto3" json:"entityInfo,omitempty"`
}
...
func (x *Entity) GetEntityInfo() []byte {
	if x != nil {
		return x.EntityInfo
	}
	return nil
...
var file_authenticator_proto_rawDesc = []byte{
	...
	0x12, 0x1e, 0x0a, 0x0a, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x49, 0x6e, 0x66, 0x6f,
